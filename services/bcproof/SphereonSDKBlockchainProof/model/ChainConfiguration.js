...
(function(root, factory) {
   ...
   * @module ../model/ChainConfiguration
   * @version 0.9
   */

  /**
   * Constructs a new <code>ChainConfiguration</code>.
   * @alias module:../model/ChainConfiguration
   * @class
   * @param context {String}
   * @param name {String}
   * @param settingChainId {String}
   * @param id {String}
   * @param accessMode {module:../model/ChainConfiguration.AccessModeEnum}
   */
   ...
   * @param {module:../model/ChainConfiguration} obj Optional instance to populate.
   * @return {module:../model/ChainConfiguration} The populated <code>ChainConfiguration</code> instance.
   */
  ...
  /**
   * @member {module:../model/ChainConfiguration.AccessModeEnum} accessMode
   */
