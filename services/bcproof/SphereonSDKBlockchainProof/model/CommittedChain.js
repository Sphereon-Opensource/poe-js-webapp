...
(function(root, factory) {
   ...
   * Committed Chain
   * @alias module:../model/CommittedChain
   * @class
   */
   ...
   * @param {module:../model/CommittedChain} obj Optional instance to populate.
   * @return {module:../model/CommittedChain} The populated <code>CommittedChain</code> instance.
   */
